...
export default function DashboardPage() {
  ...
  const navSections = [
    { title: 'Workloads', items: [{ href: '/workloads', icon: Briefcase, label: 'All Workloads' }, { href: '/workloads/create', icon: PlusCircle, label: 'Create Workload' }, { href: '/workloads/sample-workload', icon: ArrowRight, label: 'Workload Detail' }] },
    { title: 'Execution', items: [{ href: '/execution/active', icon: PlayCircle, label: 'Active Jobs' }, { href: '/execution/history', icon: History, label: 'Job History' }, { href: '/execution/graph', icon: Network, label: 'Execution Graph' }, { href: '/execution/failover', icon: RefreshCw, label: 'Retry / Failover Monitor' }] },
    { title: 'Discovery', items: [{ href: '/engine', icon: Search, label: 'Engine' }] },
    { title: 'Decision', items: [{ href: '/decide', icon: BarChart2, label: 'Decide' }] },
    { title: 'Observability', items: [{ href: '/observability/runtime-metrics', icon: Activity, label: 'Runtime Metrics' }, { href: '/observability/cost-analytics', icon: LineChartIcon, label: 'Cost Analytics' }, { href: '/observability/savings-dashboard', icon: PiggyBank, label: 'Savings Dashboard' }, { href: '/observability/sla-monitoring', icon: ShieldCheck, label: 'SLA Monitoring' }, { href: '/observability/execution-timeline', icon: Timer, label: 'Execution Timeline' }] },
    { title: 'Policies', items: [{ href: '/settings/policies', icon: ShieldCheck, label: 'Policies' }] },
    { title: 'Providers', items: [{ href: '/settings/providers', icon: Building2, label: 'All Providers' }, { href: '/settings/providers/create', icon: PlusCircle, label: 'Create Provider' }] },
    { title: 'Settings', items: [{ href: '/settings/company', icon: Building2, label: 'Company' }, { href: '/settings/team-roles', icon: Users, label: 'Team & Roles' }, { href: '/settings/api-keys', icon: KeyRound, label: 'API Keys' }, { href: '/settings/notifications', icon: Bell, label: 'Notifications' }, { href: '/settings/security', icon: Lock, label: 'Security' }] },
  ]
